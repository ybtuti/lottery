...
def get_contract(contract_name):
    """This function grabs contract address from brownie config otherwise deploys a mock contract and returns that mock contract.
...
def fund_with_link(contract_address, account=None, link_token=None, amount=100000000000000000):
    ...
    #link_token_contract = interface.LinklTokenInterface(link_token.address)
